  ...
  template: `
    <section class="min-h-[80vh] flex flex-col justify-center gap-8 py-24 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full space-y-6">
        <p class="font-label text-secondary font-semibold uppercase tracking-[0.2em]">The Architectural Core</p>
        <h1 class="font-display text-5xl md:text-6xl lg:text-7xl font-bold leading-tight -tracking-[0.04em] text-on-surface">
          Engineering High-Tech <br/>
          <span class="text-transparent bg-clip-text bg-hero-gradient">Editorial Experiences.</span>
        </h1>
        <p class="font-body text-lg md:text-xl text-on-surface-variant max-w-2xl leading-relaxed mt-6">
          Showcasing production-ready Angular architecture through a lens of luxury digital design. Modular, typed, and incredibly performant.
        </p>
        ...
        <div class="pt-10 flex flex-col sm:flex-row gap-4">
          ...
          <button class="btn-secondary px-8 py-4 font-label font-bold tracking-wide flex items-center justify-center gap-3 w-full sm:w-auto">
